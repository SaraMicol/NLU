...
class State(object):
    ...
    def copy(self):
        #Create  new istance with the copy of the attributes
        return State(
            s=self.S.copy(),  # Copia della lista stack
            b=self.B.copy(),  # Copia della lista buffer
            a=self.A.copy()   # Copia del set di archi
        )
